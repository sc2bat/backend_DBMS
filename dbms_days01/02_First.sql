...
-- 데이터 베이스의 조작 운영을 가능하게 하느 프로그램 : DBMS(Database Management System)
-- 각 데이터베이스 제품들에는 자신의 데이터베이스를 관리할 수 있는 DBMS 가 존재합니다.
-- 오라클 데이터베이스에서 사용가능한 DBMS : SQL Developer, SQL PLUS, 이클립스 등

-- 데이터 베이스의 활용 분야 : 일반웹사이트 게시판의 게시물 저장용, 포털 검색 사이트 검색 대상 정보
-- 저장용, RPG 등 게임의 게임정보 또는 캐릭터 정보, 회원들의 회원정보 등

-- 데이터베이스에 활용되는 언어(Language)
-- SQL(Structuerd Query Language) : 관계형 데이터베이스 관리 시스템 (RDBMS) 의 데이터를
...
-- DML(Database Management Language) - 데이터 조작어
